...
import { useGpxAnimation, useMapbox, useMapRecording, TrackingMode } from '../composables';
import { Button } from '@/components/ui/button'
import { ToggleGroup, ToggleGroupItem } from '@/components/ui/toggle-group'
import { Progress } from '@/components/ui/progress'
import { Play, Pause, RotateCcw, MapPin, ArrowLeftRight, Lightbulb, Target, Binoculars, ArrowUp, Flag, Video, Square } from 'lucide-vue-next'
// ============================================
// Configuration
// ============================================
...
<template>
  <div style="position: relative; height: 100vh; width: 100%;">
    ...
    ">
      ...
      <Button v-if="!isRecording" @click="startRecording" variant="destructive" size="sm">
        <Video class="w-4 h-4 mr-2" />
        Record
      </Button>

      <Button v-if="isRecording" @click="stopRecording" variant="destructive" size="sm">
        <Square class="w-4 h-4 mr-2 fill-current" />
        Stop
      </Button>

      <span v-if="isRecording" style="font-size: 12px; color: #ef4444; font-weight: 600; min-width: 45px;">
